...
*/
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws
        ...
        List<PublicationDTO> publications =( (PublicationFacade)getServletContext().getAttribute("publicationFacade")).findAllByTitle(sorting,searchReq);
        final String url = "/search";
        int lastPage = publicationFacade.countAllByTitle(searchReq) % Integer.parseInt(pageSize) == 0 ? publicationFacade.countAllByTitle(searchReq) / Integer.parseInt(pageSize) : publicationFacade.countAllByTitle(searchReq) / Integer.parseInt(pageSize) + 1;
        request.setAttribute("lastPage", lastPage);
        request.setAttribute("currentPage", currentPage);
